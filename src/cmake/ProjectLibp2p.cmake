...
if (MSVC)
  ...
  set(P2PUTILS_LIBRARY       debug P2PUTILS_LIBRARY_DEBUG       optimized P2PUTILS_LIBRARY_OPTIMIZED)
    ...
    set_target_properties(ASYNCIO_LIBRARY__        PROPERTIES IMPORTED_LOCATION ${LIBP2P_BUILD_DIRECTORY}/asyncio/${CMAKE_STATIC_LIBRARY_PREFIX}asyncio-${LIBP2P_VERSION}${CMAKE_STATIC_LIBRARY_SUFFIX})
    set_target_properties(ASYNCIO_EXTRAS_LIBRARY__ PROPERTIES IMPORTED_LOCATION ${LIBP2P_BUILD_DIRECTORY}/asyncioextras/${CMAKE_STATIC_LIBRARY_PREFIX}asyncioextras-${LIBP2P_VERSION}${CMAKE_STATIC_LIBRARY_SUFFIX})
    set_target_properties(P2P_LIBRARY__            PROPERTIES IMPORTED_LOCATION ${LIBP2P_BUILD_DIRECTORY}/p2p/${CMAKE_STATIC_LIBRARY_PREFIX}p2p${CMAKE_STATIC_LIBRARY_SUFFIX})
    set_target_properties(P2PUTILS_LIBRARY__       PROPERTIES IMPORTED_LOCATION ${LIBP2P_BUILD_DIRECTORY}/p2putils/${CMAKE_STATIC_LIBRARY_PREFIX}p2putils${CMAKE_STATIC_LIBRARY_SUFFIX})
