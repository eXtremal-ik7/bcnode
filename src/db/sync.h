...
// still needs, the reader decodes each wave and the pipeline returns batches in order. Databases
// wake up at different heights and each takes its own tail of a batch
