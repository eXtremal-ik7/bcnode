...
public:
  ...
  bool initialize(BlockInMemoryIndex &blockIndex, std::filesystem::path &dataDir, BC::Common::BlockIndex **forConnect, IndexDbMap &forDisconnect);
...
#pragma pack(pop)
  ...
  struct Shard {
    ...
    tbb::concurrent_hash_map<BC::Proto::BlockHashTy, TxLink, TbbHash256> Cache;
  };
